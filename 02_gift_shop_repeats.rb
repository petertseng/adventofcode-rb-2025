...
def repeat_any(range)
  ...
  when 6; sum_multiples(10101, range) + sum_multiples(1001, range) - sum_multiples(111111, range)
  when 7; sum_multiples(1111111, range)
  when 8; sum_multiples(10001, range)
  when 9; sum_multiples(1001001, range)
  when 10; sum_multiples(101010101, range) + sum_multiples(100001, range) - sum_multiples(1111111111, range)
