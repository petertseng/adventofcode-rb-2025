...
if [ "$yes" = "1" ]; then
  if [ -f input$day ]; then
    ...
    curl --cookie session=$(cat secrets/session) --user-agent 'https://github.com/petertseng/adventofcode-rb-2025/blob/master/fetch.sh' -o input$day https://adventofcode.com/2025/day/$day/input
  fi
else
